...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  selectedLayers.forEach(function (item) {
    ...
    documentStyles.forEach(function (el) {
      ...
      if (selectedStyleName[0] === docStyleName[1] || selectedStyleName[0] === docStyleName[0]) {
        hasStyle = true;
      }
    });
    ...
    if (hasStyle) {
      ...
      if (styles[partialStyleName].count <= 1) {
        newStyleName = partialStyleName;
      }

      if (styles[partialStyleName].count > 1) {
        newStyleName = partialStyleName + " " + styles[partialStyleName].count;
      }
    }
...
//# sourceMappingURL=__createNewStyles.js.map